...
const Page: React.FC = () => {
  ...
  const query = searchParams.get("q"); // Access the 'q' query parameter
  const dispatch = useAppDispatch();

  useEffect(() => {
    setIsClient(true);
    dispatch(fetchProductsData({ search: query }));
  }, []);
  useEffect(() => {
    dispatch(fetchProductsData({ search: query }));
  }, [dispatch]);
          ...
          {paginatedProducts.map((product) => (
            ...
            >
              <div className="group relative cursor-pointer overflow-hidden rounded-lg transition-all duration-300 ease-in-out hover:scale-105 shadow-md hover:shadow-lg">
                ...
                {/* <div className="relative hover-effect aspect-square overflow-hidden">
                  <Image
                ...
                <div className="p-2  bg-white">
                  <h3 className="text-sm md:text-base font-medium mb-2 line-clamp-2">
                    {product.name}
                  </h3>
